...
public class DatabaseCleaner {
    ...
    public void sortItemGuids() throws SQLException {
        Log.print("Moving all item guids: after highest guid");
        ItemGuidSortTask task1 = new ItemGuidSortTask();
        int newItemStartGuid = highestItemGuid + 1;
        task1.run(connection, lowestCharacterGuid, highestCharacterGuid, newItemStartGuid, true);
        ...
        Log.print("Moving all item guids: start from 1");
        ItemGuidSortTask task2 = new ItemGuidSortTask();
        newItemStartGuid = 1;
        task2.run(connection, lowestCharacterGuid, highestCharacterGuid, newItemStartGuid, false);
    }
